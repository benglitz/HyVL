...
- Sampling Rate: 250 kHz should be sufficient for rodents.
...
VocCollector accepts multiple input formats, all passed in the typical format of Name,Value pairs. In our integrated toolchain, recordings can be directly loaded and processed by specifying the animal and recording number. For the purpose of this tutorial it makes more sense to instead base it on passed data, such as the one you might have acquired.
