...
R.Localization =  C_convertCam64ResultsToController('Data',Localization.Vocs,'SetupInfo',Setup);
...
Files = {...
  ...
  'Access/Vocalizations/VocCollector.m','Main';...
  'Access/Vocalizations/HF_specgram.m','Helpers';...
  'Access/Vocalizations/ToolsHoly/C_SpectralContinuity.m','Helpers';...
  'Access/Vocalizations/Cam64/C_convertCam64ResultsToController.m','Main';...
  'Access/Vocalizations/Cam64/C_mapCam64.m','Helpers';...
  'Access/Vocalizations/Cam64/C_correctImageDistortions.m','Helpers';...
  'Access/Vocalizations/Beamforming/C_BeamformingTime.m','Helpers';...
  'Access/Vocalizations/Beamforming/algorithm/nearfieldDelayAndSum.m','Helpers';...
  'Access/Vocalizations/Beamforming/algorithm/nearfieldDelayAndSumGPU.m','Helpers';...
  'Access/Vocalizations/Beamforming/algorithm/nearfieldDelayAndSumGPU2.m','Helpers';...
  'Access/Vocalizations/Beamforming/algorithm/nearfieldDelayAndSumGPU3.m','Helpers';...
  'Plot/Helpers/axesDivide.m','Helpers';...
  'Plot/Helpers/HF_colormap.m','Helpers';...
  'Helpers/parsePairs.m','Helpers';...
  'Helpers/HF_autobin.m','Helpers';...
  'Helpers/C_autobin.m','Helpers';...
  'Helpers/C_parseID.m','Helpers';...
  'Helpers/checkField.m','Helpers';...
  'Helpers/vertical.m','Helpers';...
  'Helpers/printupdate.m','Helpers';...
  'Helpers/mat2vec.m','Helpers';...
  'Helpers/CurvatureFlowFilter.m','Helpers';...
  'Helpers/skewnesspdf.m','Helpers';...
 'Helpers/meanpdf.m','Helpers';...
 'Helpers/stdpdf.m','Helpers';...
 'Helpers/varpdf.m','Helpers';...
 'Helpers/kurtosispdf.m','Helpers';...
 'Helpers/findLocalExtrema.m','Helpers';...
 'Helpers/C_addRamp.m','Helpers';...
  'Access/MultiViewer/MultiViewer.m','Main',...
};

for iF=1:length(Files) copyfile([SourcePath,Files{iF,1}],[TargetPath,Files{iF,2}]); end
